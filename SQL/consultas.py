...
flujo_migratorio_neto = psql.sqldf(consulta_flujo_migratorio, env=datos)
print(flujo_migratorio_neto)

# Paso 3: Unir los resultados de sedes_secciones y flujo_migratorio_neto
consulta_final = '''
    SELECT ss.pais_iso_3 AS country, 
           ss.sedes_count, 
           ss.secciones_prom, 
    ...
    ORDER BY ss.sedes_count DESC, ss.pais_iso_3 ASC
'''.format(consulta_sedes_secciones, consulta_flujo_migratorio)

# Ejecutar la consulta final
resultado_final = psql.sqldf(consulta_final, env=datos)
